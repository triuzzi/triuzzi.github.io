...
const pages = {
  ...
  work: {
    ...
    content: (
      <>
        <h1>Work</h1>
        <p>Currently at Bending Spoons.</p>
        <p>
          Background in distributed systems, databases, and cloud infrastructure. 
          Experience with high-availability backends, mobile development, and full-stack web applications.
        </p>
      </>
    )
  },
